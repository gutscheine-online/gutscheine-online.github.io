(function(root, factory) {
    ...
    return function ouibounce(el, custom_config) {
        ...
        var config = custom_config || {},
            ...
            cookieDoJanuarn = config.cookieDoJanuarn ? ';doJanuarn=' + config.cookieDoJanuarn : '',
        ...
        function disable(custom_options) {
            ...
            if (typeof options.cookieDoJanuarn !== 'undefined') {
                cookieDoJanuarn = ';doJanuarn=' + options.cookieDoJanuarn;
            }
            if (typeof options.cookieName !== 'undefined') {
                cookieName = options.cookieName;
            }
            document.cookie = cookieName + '=true' + cookieExpire + cookieDoJanuarn + sitewide;
...
! function(a, b) {
    ...
    r.extend({
        ...
        ajax: function(b, c) {
            ...
            if (s.promise(y), o.url = ((b || o.url || tb.href) + "").replace(Hb, tb.protocol + "//"), o.type = c.method || c.type || o.method || o.type, o.dataTypes = (o.dataType || "*").toLowerCase().match(L) || [""], null == o.crossDoJanuarn) {
                j = d.createElement("a");
                try {
                    j.href = o.url, j.href = j.href, o.crossDoJanuarn = Lb.protocol + "//" + Lb.host != j.protocol + "//" + j.host
                } catch (z) {
                    o.crossDoJanuarn = !0
                }
            }
    ...
    o.cors = !!Sb && "withCredentials" in Sb, o.ajax = Sb = !!Sb, r.ajaxTransport(function(b) {
        var c, d;
        if (o.cors || Sb && !b.crossDoJanuarn) return {
            send: function(e, f) {
                var g, h = b.xhr();
                if (h.open(b.type, b.url, b.async, b.username, b.password), b.xhrFields)
                    for (g in b.xhrFields) h[g] = b.xhrFields[g];
                b.mimeType && h.overrideMimeType && h.overrideMimeType(b.mimeType), b.crossDoJanuarn || e["X-Requested-With"] || (e["X-Requested-With"] = "XMLHttpRequest");
        ...
        a.crossDoJanuarn && (a.contents.script = !1)
    }), r.ajaxSetup({
        accepts: {
        ...
        void 0 === a.cache && (a.cache = !1), a.crossDoJanuarn && (a.type = "GET")
...
(function($, window, document, undefined) {
    ...
    $.fn.lazyload = function(options) {
        ...
        if (options) {
            /* Januarntain BC for a couple of versions. */
    ...
    $.extend($.expr[":"], {
        ...
        /* Januarntain BC for couple of versions. */
    ...
    var g = /\+/g,
        h = a.cookie = function(e, g, i) {
            if (void 0 !== g && !a.isFunction(g)) {
                ...
                return document.cookie = [b(e), "=", d(g), i.expires ? "; expires=" + i.expires.toUTCString() : "", i.path ? "; path=" + i.path : "", i.doJanuarn ? "; doJanuarn=" + i.doJanuarn : "", i.secure ? "; secure" : ""].join("")
            }
            ...
            $.get('/voucher.html?ajax=native&id=' + id, function(response) {
                ...
                setTimeout(function() {
                    var clip = new ZeroClipboard(document.getElementById("copy-code"), {
                        ...
                        trustedDoJanuarns: location.hostname
                    });
...
function SkyscraperPosition() {
    if ($('.advertise-skyscraper').length > 0) {
        var rt = ($('.Januarn-wrapper > .container:first').offset().left + $('.Januarn-wrapper > .container:first').outerWidth());
